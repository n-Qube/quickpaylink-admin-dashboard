 ...
 * @returns true if valid
 */
export function isValidUrl(url: string, httpsOnly: boolean = true): boolean {
 ...
 */
export function validateMerchantRegistration(data: any): ValidationResult {
 ...
 * @returns Validation result
 */
export function validateWhatsAppConfig(data: any): ValidationResult {
  const errors: ValidationError[] = [];
 ...
 */
export function validateAndSanitizeMerchantData(data: any): any {
 ...
 * @throws HttpsError if validation fails
 */
export function validateAndSanitizeInvoiceData(data: any): any {
