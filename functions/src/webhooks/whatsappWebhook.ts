...
/**
 * WhatsApp Message Echo Webhook Handler
 *
 * Handles smb_message_echoes webhooks from 360Dialog for WhatsApp Coexistence mode
 * Stores messages sent from WhatsApp Business App to maintain message history
 *
 * @see https://docs.360dialog.com/docs/waba-management/the-360-client-hub/embedded-signup/whatsapp-coexistence/coexistence-webhooks
 */
...
interface MessageEcho {
  ...
  timestamp: string;
  type: string;
  [key: string]: any; // For message type specific content
}
 ...
 */
export const cleanupOldMessageEchoes = functions.pubsub
