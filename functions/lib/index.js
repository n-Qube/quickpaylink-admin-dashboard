 ...
 */
async function verifyAppCheckToken(context) {
    ...
    try {
        ...
        await appCheck.verifyToken(context.app);
        return true;
    }
    catch (error) {
...
exports.sendOTP = functions.https.onCall(async (data, context) => {
    try {
        ...
        if (!isValidAppCheck && process.env.NODE_ENV === 'production') {
            throw new functions.https.HttpsError('failed-precondition', 'App Check verification failed. Please use an official app.');
        }
        const { phoneNumber } = data;
        // Validate phone number format
        if (!phoneNumber || !(0, validation_1.isValidPhoneNumber)(phoneNumber)) {
            throw new functions.https.HttpsError('invalid-argument', 'Invalid phone number format. Use international format: +233XXXXXXXXX');
        }
        // Rate limiting: Max 5 OTP requests per hour per phone number
        await (0, rateLimiter_1.rateLimitMiddleware)(context, 'sendOTP', rateLimiter_1.RATE_LIMITS.OTP_SEND, 'phoneNumber', phoneNumber);
        // Generate OTP
        ...
        const whatsappResult = await (0, whatsappService_1.sendWhatsAppOTP)(phoneNumber, otp);
...
exports.verifyOTP = functions.https.onCall(async (data, context) => {
    try {
        ...
        // Validate OTP format
        if (!otp || !(0, validation_1.isValidOTP)(otp)) {
        ...
        await (0, rateLimiter_1.rateLimitMiddleware)(context, 'verifyOTP', rateLimiter_1.RATE_LIMITS.OTP_VERIFY, 'phoneNumber', phoneNumber);
        ...
        const otpQuery = await getDb()
            ...
            .get();
        if (otpQuery.empty) {
            throw new functions.https.HttpsError('not-found', 'No OTP found for this phone number');
        }
...
exports.requestPayout = functions.https.onCall(async (data, context) => {
    try {
        ...
        if (!context.auth) {
            throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to request payout');
        }
        // Rate limiting: Max 10 payout requests per hour per merchant
        await (0, rateLimiter_1.rateLimitMiddleware)(context, 'requestPayout', rateLimiter_1.RATE_LIMITS.PAYOUT_REQUEST, 'merchant');
        const merchantId = context.auth.uid;
        const { amount, currency, bankDetails } = data;
        // Validate inputs
        if (!amount || !currency || !bankDetails) {
            throw new functions.https.HttpsError('invalid-argument', 'Amount, currency, and bank details are required');
        }
        if (amount <= 0) {
        ...
        if ((merchantData === null || merchantData === void 0 ? void 0 : merchantData.status) !== 'active') {
            throw new functions.https.HttpsError('failed-precondition', 'Merchant account must be active to request payout');
        }
        ...
        throw new functions.https.HttpsError('internal', error.message || 'Failed to request payout');
    }
});
// ============================================================================
 ...
 */
exports.processManualPayout = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    try {
        // Check authentication
        if (!context.auth) {
            throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to process manual payout');
        }
        ...
        if (!adminDoc.exists) {
            throw new functions.https.HttpsError('permission-denied', 'Only admins can process manual payouts');
        }
        const adminData = adminDoc.data();
        if ((adminData === null || adminData === void 0 ? void 0 : adminData.status) !== 'active') {
            throw new functions.https.HttpsError('permission-denied', 'Admin account must be active to process payouts');
        }
        // Get merchant data
        const merchantDoc = await getDb().collection('merchants').doc(merchantId).get();
        if (!merchantDoc.exists) {
        ...
        // Check if merchant is active
        if ((merchantData === null || merchantData === void 0 ? void 0 : merchantData.status) !== 'active') {
            throw new functions.https.HttpsError('failed-precondition', 'Merchant account must be active to process payout');
        }
        // Validate payout details
        if (!((_a = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _a === void 0 ? void 0 : _a.recipientCode)) {
            throw new functions.https.HttpsError('failed-precondition', 'Merchant does not have payout details configured. Please add bank account or mobile money details first.');
        }
        ...
        const payoutData = {
            ...
            currency: (merchantData === null || merchantData === void 0 ? void 0 : merchantData.defaultCurrency) || 'GHS',
            fee: 0, // TODO: Calculate actual transfer fee
            netAmount: (amount || 0), // TODO: Subtract fee
            recipient: {
                type: ((_b = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _b === void 0 ? void 0 : _b.type) || 'bank',
                recipientCode: (_c = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _c === void 0 ? void 0 : _c.recipientCode,
                accountNumber: ((_d = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _d === void 0 ? void 0 : _d.accountNumber) || '',
                accountName: ((_e = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _e === void 0 ? void 0 : _e.accountName) || '',
                bankCode: (_f = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _f === void 0 ? void 0 : _f.bankCode,
                bankName: (_g = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _g === void 0 ? void 0 : _g.bankName,
                mobileProvider: (_h = merchantData === null || merchantData === void 0 ? void 0 : merchantData.payoutDetails) === null || _h === void 0 ? void 0 : _h.mobileProvider,
            },
            paystack: {
        ...
        throw new functions.https.HttpsError('internal', error.message || 'Failed to process manual payout');
    }
});
// ============================================================================
 ...
 */
exports.validateMerchantData = functions.firestore
    ...
    try {
        // Validate phone number format
        if ((_a = data.contactInfo) === null || _a === void 0 ? void 0 : _a.phoneNumber) {
        ...
        if ((_b = data.businessInfo) === null || _b === void 0 ? void 0 : _b.email) {
        ...
        if ((_c = data.businessInfo) === null || _c === void 0 ? void 0 : _c.businessName) {
 ...
 */
exports.validateInvoiceData = functions.firestore
 ...
 */
exports.updateInvoiceOnPayment = functions.firestore
 ...
 */
exports.notifyOnTicketUpdate = functions.firestore
...
exports.cleanupOldRateLimits = functions.pubsub
    ...
    .onRun(async (context) => {
    try {
        const deletedCount = await (0, rateLimiter_1.cleanupRateLimits)();
...
Object.defineProperty(exports, "cleanupOldMessageEchoes", { enumerable: true, get: function () { return whatsappWebhook_1.cleanupOldMessageEchoes; } });
// ==================== Configuration Management ====================
var configFunctions_1 = require("./config/configFunctions");
Object.defineProperty(exports, "getSystemConfig", { enumerable: true, get: function () { return configFunctions_1.getSystemConfig; } });
Object.defineProperty(exports, "getSubscriptionPlans", { enumerable: true, get: function () { return configFunctions_1.getSubscriptionPlans; } });
Object.defineProperty(exports, "getSubscriptionPlan", { enumerable: true, get: function () { return configFunctions_1.getSubscriptionPlan; } });
Object.defineProperty(exports, "getMerchantSubscription", { enumerable: true, get: function () { return configFunctions_1.getMerchantSubscription; } });
Object.defineProperty(exports, "subscribeToPlan", { enumerable: true, get: function () { return configFunctions_1.subscribeToPlan; } });
Object.defineProperty(exports, "checkFeatureAccess", { enumerable: true, get: function () { return configFunctions_1.checkFeatureAccess; } });
Object.defineProperty(exports, "checkUsageLimit", { enumerable: true, get: function () { return configFunctions_1.checkUsageLimit; } });
// ==================== API Key Migration ====================
var migrateApiKeys_1 = require("./migration/migrateApiKeys");
Object.defineProperty(exports, "migrateWhatsAppApiKeys", { enumerable: true, get: function () { return migrateApiKeys_1.migrateWhatsAppApiKeys; } });
